                ...
                if (!joinedRef.current) {
                    try {
                        const tokenResponse = await fetch(
                            `${import.meta.env.VITE_BACKEND_URL}/api/agora/token?channelName=${encodeURIComponent(roomId)}&uid=${uid}`
                        );
                        ...
                        if (!joinedRef.current) {
                            alert(
                                'Failed to join video channel. Please try again.'
                            );
                        }
